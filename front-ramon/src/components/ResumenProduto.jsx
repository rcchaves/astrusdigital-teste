...
export default function ResumenProduto({produto}) {
    ...
    const { handleEditarQuantidade, handleEliminarProdutoPedido} = usePedido();
        ...
        return (
            <div className="shadow space-y-1 p-4 bg-white">
              <div className="space-y-2">
                ...
                <p className="text-lg font-bold ">Quantidade: {quantidade}</p>
              ...
              <div className="flex justify-between gap-2 pb-4">
                <button
                  ...
                  onClick={() => handleEditarQuantidade(id)}
                >
                  <svg
